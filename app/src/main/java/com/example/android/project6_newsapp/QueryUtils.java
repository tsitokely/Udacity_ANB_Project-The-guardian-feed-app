...
public class QueryUtils {
    ...
    /**
     * Query the "the guardian api" and return a list of {@link Story} objects.
     */
    ...
    private static List<Story> extractFeatureFromJson(String storyJSON) {
        ...
        try {
            ...
            // Extract the JSONObject response from the JSON base
            ...
            for (int i = 0; i < resultArray.length(); i++) {
                ...
                // key called "fields" to extract the story author
                ...
                // Create a new {@link Story} object with the title, section, author, url
